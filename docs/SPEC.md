...
NanoClaw runs as a launchd service (macOS) or systemd service (Linux).
...
| "Claude Code process exited with code 1" | Docker not running | Check logs; NanoClaw auto-starts container system but may fail |
